      ...
      {/* {!profile.uid === true ? (
        ...
        > */}
          {/* <div className="flex flex-col   w-full ">
            <h1 className="text-2xl px-5 font-semibold my-7">
              Company&apos;s Projects Proposals
            </h1>
            ...
            <div className="border-t px-5 py-5 border-slate-300 justify-start md:justify-between gap-2 md:gap-5 relative">
              {orgProposals &&
                orgProposals.map((proposal) => (
                  <div
                    className="flex items-start justify-start md:items-start md:justify-start my-5 relative"
                    key={proposal.uid}
                  >
                    -----------Thumbnail------------
                    ...
                    <div className="flex order-2 md:w-1/2 md:pl-6 flex-col items-start">
                      ...
                      <p
                        ...
                        className={`border py-0.5 px-1 md:px-2 md:py-1 bg-accent/5 text-xs md:text-sm rounded-2xl text-accent ${
                          proposal.pending
                            ? "bg-yellow-100/50 text-orange-600 border-orange-300"
                            : proposal.accepted
                      ...
                      <Link
                        to={`/projects/${proposal.project.uid}`}
                        className="text-lg md:text-xl font-semibold md:mt-3 hover:text-accent"
                      >
                      ...
                      <p className="description mb-4 text-xs md:text-sm">
                        Proposal : {proposal.uid} by {proposal.developer.fname}{" "}
                    ...
                    <div className="absolute top-0 right-0 md:flex">
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex items-center text-green-500 text-xl lg:text-2xl bg-green-50 hover:bg-green-500
                           hover:text-white p-3 rounded-xl ${
                             proposal.accepted ? "hidden" : ""
                           }`}
                        >
                          <p className="hidden md:flex text-sm md:text-base pr-1 md:px-2">
                            Accept
                          </p>
                          <TiThumbsUp />
                        </button>
                        ...
                        <button
                          onClick={() =>
                            handleProposal("pending", proposal.uid)
                          }
